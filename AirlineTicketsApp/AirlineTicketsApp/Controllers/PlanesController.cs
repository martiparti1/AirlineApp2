...
namespace AirlineTicketsApp.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Model,ImageURL,HandLuggageVolume,BarOnBoard,SeatsCount")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Model,ImageURL,HandLuggageVolume,BarOnBoard,SeatsCount")] Plane plane)
        {
            if (id != plane.Id)
            {
                return NotFound();
